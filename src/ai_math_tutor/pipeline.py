...
import torch
from ai_math_tutor.rules import EXTRACTION_RULES, REASONING_RULES
import json
...
class Pipeline:
    ...
    def extraction_layer(self, image):
        ...
        decoded_extract = self.extraction_processor.batch_decode(
            extracted_only,
    ...
    def reasoning_layer(self, extracted_math):
        ...
        response_tokens = input_plus_response[:, input_len:]

        response = self.reasoning_and_tutor_tokenizer.batch_decode(
